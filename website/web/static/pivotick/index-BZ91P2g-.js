...
var pa = (i, t, e) => t in i ? ua(i, t, { enumerable: !0, configurable: !0, writable: !0, value: e }) : i[t] = e;
var g = (i, t, e) => pa(i, typeof t != "symbol" ? t + "" : t, e);
function st(i, ...t) {
  if (typeof i == "string")
    return i;
...
function ft(i) {
  ...
  for (const [f, v] of Object.entries(h))
    f === "class" ? Array.isArray(v) ? d.classList.add(...v) : d.classList.add(String(v)) : f in d ? d[f] = v : d.setAttribute(f, String(v));
  let u;
...
function ya(i, t, e, n = {}) {
  ...
  function d(p) {
    var C;
    if (!r || !h || !l) return;
    const f = p.clientX - s, v = p.clientY - o;
    let y = a + f, b = c + v;
  ...
  function u(p) {
    var f;
    r = !1, i.style.transition = "", (f = n.onDragStop) == null || f.call(n, p, i);
  }
}
let Mt = class es {
  /**
...
class _t {
  ...
  constructor(t, e, n, r, s, o = null, a) {
    ...
    g(this, "syntheticTerminalNode");
    g(this, "_original_object");
    g(this, "_subgraphFromNode");
    g(this, "_subgraphToNode");
    g(this, "_dirty");
    g(this, "domID");
...
function is(i) {
  var t = vi(i);
  return (t.local ? wa : ba)(t);
}
function xa() {
}
function Mn(i) {
  return i == null ? xa : function() {
...
function ns(i) {
  return i == null ? Ea : function() {
    return this.querySelectorAll(i);
  };
}
function Sa(i) {
  return function() {
    return Ma(i.apply(this, arguments));
  };
}
function _a(i) {
  typeof i == "function" ? i = Sa(i) : i = ns(i);
...
function Na(i) {
  return function() {
    return ka.call(this.children, i);
  };
}
function Aa() {
...
function Ia(i) {
  return this.select(i == null ? Aa : Na(typeof i == "function" ? i : ss(i)));
}
...
function Ta(i) {
  return function() {
    return La.call(this.children, i);
  };
}
function Pa(i) {
  return this.selectAll(i == null ? Oa : Ta(typeof i == "function" ? i : ss(i)));
}
function Da(i) {
...
function $a(i, t) {
  ...
  var e = t ? Ra : Ba, n = this._parents, r = this._groups;
  typeof i != "function" && (i = za(i));
  for (var s = r.length, o = new Array(s), a = new Array(s), c = new Array(s), l = 0; l < s; ++l) {
    var h = n[l], d = r[l], u = d.length, p = Ga(i.call(h, h && h.__data__, l, n)), f = p.length, v = a[l] = new Array(f), y = o[l] = new Array(f), b = c[l] = new Array(u);
    e(h, d, v, y, b, p, t);
    for (var x = 0, S = 0, C, N; x < f; ++x)
      if (C = v[x]) {
        for (x >= S && (S = x + 1); !(N = y[S]) && ++S < f; ) ;
        C._next = N || null;
      }
  }
...
function Ua(i) {
  for (var t = i.selection ? i.selection() : i, e = this._groups, n = t._groups, r = e.length, s = n.length, o = Math.min(r, s), a = new Array(r), c = 0; c < o; ++c)
    for (var l = e[c], h = n[c], d = l.length, u = a[c] = new Array(d), p, f = 0; f < d; ++f)
      (p = l[f] || h[f]) && (u[f] = p);
  for (; c < r; ++c)
    a[c] = e[c];
...
function al(i, t) {
  ...
  return this.each((t == null ? e.local ? il : el : typeof t == "function" ? e.local ? ol : sl : e.local ? rl : nl)(e, t));
}
function as(i) {
...
function dl(i, t, e) {
  return arguments.length > 1 ? this.each((t == null ? ll : typeof t == "function" ? hl : cl)(i, t, e ?? "")) : oe(this.node(), i);
}
function oe(i, t) {
...
function gl(i, t) {
  return arguments.length > 1 ? this.each((t == null ? ul : typeof t == "function" ? fl : pl)(i, t)) : this.node()[i];
}
function ls(i) {
...
function bl(i, t) {
  ...
  return this.each((typeof t == "function" ? yl : t ? ml : vl)(e, t));
}
function wl() {
  this.textContent = "";
}
...
function Ml(i) {
  return arguments.length ? this.each(i == null ? wl : (typeof i == "function" ? Cl : xl)(i)) : this.node().textContent;
}
function El() {
  this.innerHTML = "";
}
...
function kl(i) {
  return arguments.length ? this.each(i == null ? El : (typeof i == "function" ? _l : Sl)(i)) : this.node().innerHTML;
}
function Nl() {
...
function Pl(i, t) {
  var e = typeof i == "function" ? i : is(i), n = t == null ? Tl : typeof t == "function" ? t : Mn(t);
  return this.select(function() {
...
function Ul(i, t, e) {
  ...
  for (a = t ? Vl : ql, r = 0; r < s; ++r) this.each(a(n[r], t, e));
  return this;
}
function us(i, t, e) {
...
function Xl(i, t) {
  return this.each((typeof t == "function" ? Yl : jl)(i, t));
}
function* Wl() {
  for (var i = this._groups, t = 0, e = i.length; t < e; ++t)
...
function Pt(i, t) {
  if (i = Zl(i), t === void 0 && (t = i.currentTarget), t) {
...
Ze.prototype = Ne.prototype = {
  constructor: Ze,
  on: function(i, t) {
    var e = this._, n = Jl(i + "", e), r, s = -1, o = n.length;
    if (arguments.length < 2) {
      for (; ++s < o; ) if ((r = (i = n[s]).type) && (r = tc(e[r], i.name))) return r;
      return;
    }
...
function nr(i, t, e) {
  for (var n = 0, r = i.length; n < r; ++n)
    if (i[n].name === t) {
      i[n] = Ql, i = i.slice(0, n).concat(i.slice(n + 1));
      break;
    }
...
function an(i) {
  if (!ae) {
    ...
    var t = i - Kt;
    t > 24 ? (i < 1 / 0 && (ge = setTimeout(rr, i - xe.now() - yi)), pe && (pe = clearInterval(pe))) : (pe || (li = xe.now(), pe = setInterval(nc, fs)), ae = 1, gs(rr));
  }
}
function sr(i, t, e) {
  var n = new ci();
...
var sc = Ne("start", "end", "cancel", "interrupt"), oc = [], ms = 0, or = 1, ln = 2, Qe = 3, ar = 4, cn = 5, Je = 6;
...
var Ce = 0.7, hi = 1 / Ce, ie = "\\s*([+-]?\\d+)\\s*", Me = "\\s*([+-]?(?:\\d*\\.)?\\d+(?:[eE][+-]?\\d+)?)\\s*", It = "\\s*([+-]?(?:\\d*\\.)?\\d+(?:[eE][+-]?\\d+)?)%\\s*", cc = /^#([0-9a-f]{3,8})$/, hc = new RegExp(`^rgb\\(${ie},${ie},${ie}\\)$`), dc = new RegExp(`^rgb\\(${It},${It},${It}\\)$`), uc = new RegExp(`^rgba\\(${ie},${ie},${ie},${Me}\\)$`), pc = new RegExp(`^rgba\\(${It},${It},${It},${Me}\\)$`), fc = new RegExp(`^hsl\\(${Me},${It},${It}\\)$`), gc = new RegExp(`^hsla\\(${Me},${It},${It},${Me}\\)$`), lr = {
  aliceblue: 15792383,
...
function Ee(i) {
  var t, e;
  return i = (i + "").trim().toLowerCase(), (t = cc.exec(i)) ? (e = t[1].length, t = parseInt(t[1], 16), e === 6 ? dr(t) : e === 3 ? new gt(t >> 8 & 15 | t >> 4 & 240, t >> 4 & 15 | t & 240, (t & 15) << 4 | t & 15, 1) : e === 8 ? Be(t >> 24 & 255, t >> 16 & 255, t >> 8 & 255, (t & 255) / 255) : e === 4 ? Be(t >> 12 & 15 | t >> 8 & 240, t >> 8 & 15 | t >> 4 & 240, t >> 4 & 15 | t & 240, ((t & 15) << 4 | t & 15) / 255) : null) : (t = hc.exec(i)) ? new gt(t[1], t[2], t[3], 1) : (t = dc.exec(i)) ? new gt(t[1] * 255 / 100, t[2] * 255 / 100, t[3] * 255 / 100, 1) : (t = uc.exec(i)) ? Be(t[1], t[2], t[3], t[4]) : (t = pc.exec(i)) ? Be(t[1] * 255 / 100, t[2] * 255 / 100, t[3] * 255 / 100, t[4]) : (t = fc.exec(i)) ? fr(t[1], t[2] / 100, t[3] / 100, 1) : (t = gc.exec(i)) ? fr(t[1], t[2] / 100, t[3] / 100, t[4]) : lr.hasOwnProperty(i) ? dr(lr[i]) : i === "transparent" ? new gt(NaN, NaN, NaN, 0) : null;
}
function dr(i) {
...
function hn(i, t, e, n) {
  return arguments.length === 1 ? yc(i) : new gt(i, t, e, n ?? 1);
}
function gt(i, t, e, n) {
...
function Mc(i) {
  return (i = +i) == 1 ? ws : function(t, e) {
    return e - t ? Cc(t, e, i) : bs(isNaN(t) ? e : t);
  };
}
function ws(i, t) {
  var e = t - i;
  return e ? xc(i, e) : bs(isNaN(i) ? t : i);
}
...
function _c(i, t) {
  ...
  return e < t.length && (s = t.slice(e), a[o] ? a[o] += s : a[++o] = s), a.length < 2 ? c[0] ? Sc(c[0].x) : Ec(t) : (t = c.length, function(l) {
...
function Cs(i, t, e, n) {
  ...
  function s(l, h, d, u, p, f) {
    if (l !== d || h !== u) {
      var v = p.push("translate(", null, t, null, e);
      f.push({ i: v - 4, x: Rt(l, d) }, { i: v - 2, x: Rt(h, u) });
  ...
  return function(l, h) {
    ...
    return l = i(l), h = i(h), s(l.translateX, l.translateY, h.translateX, h.translateY, d, u), o(l.rotate, h.rotate, d, u), a(l.skewX, h.skewX, d, u), c(l.scaleX, l.scaleY, h.scaleX, h.scaleY, d, u), l = h = null, function(p) {
      for (var f = -1, v = u.length, y; ++f < v; ) d[(y = u[f]).i] = y.x(p);
      return d.join("");
    };
  };
}
var Ac = Cs(kc, "px, ", "px)", "deg)"), Ic = Cs(Nc, ", ", ")", ")"), Lc = 1e-12;
function yr(i) {
...
const Pc = (function i(t, e, n) {
  function r(s, o) {
    var a = s[0], c = s[1], l = s[2], h = o[0], d = o[1], u = o[2], p = h - a, f = d - c, v = p * p + f * f, y, b;
    if (v < Lc)
      ...
      b = (P - N) / t, y = function(k) {
        var A = k * b, I = yr(N), z = l / (e * x) * (I * Tc(t * A + N) - Oc(N));
        return [
          a + z * p,
          c + z * f,
          l * I / yr(t * A + N)
...
function zc(i, t) {
  ...
  return this.each((t == null ? Dc : Fc)(e, i, t));
}
function An(i, t, e) {
  var n = i._id;
...
function Ms(i, t) {
  var e;
  return (typeof t == "number" ? Rt : t instanceof Ee ? mr : (e = Ee(t)) ? (t = e, mr) : _c)(i, t);
}
function Bc(i) {
  return function() {
    this.removeAttribute(i);
...
function Vc(i, t) {
  var e = vi(i), n = e === "transform" ? Ic : Ms;
  return this.attrTween(i, typeof t == "function" ? (e.local ? qc : Gc)(e, n, An(this, "attr." + i, t)) : t == null ? (e.local ? Rc : Bc)(e) : (e.local ? $c : Hc)(e, n, t));
}
function Uc(i, t) {
  return function(e) {
...
function Wc(i, t) {
  ...
  var n = vi(i);
  return this.tween(e, (n.local ? Yc : Xc)(n, t));
}
function Kc(i, t) {
  return function() {
...
function Qc(i) {
  var t = this._id;
  return arguments.length ? this.each((typeof i == "function" ? Kc : Zc)(t, i)) : kt(this.node(), t).delay;
}
function Jc(i, t) {
  return function() {
...
function eh(i) {
  var t = this._id;
  return arguments.length ? this.each((typeof i == "function" ? Jc : th)(t, i)) : kt(this.node(), t).duration;
}
function ih(i, t) {
  if (typeof t != "function") throw new Error();
  return function() {
...
function nh(i) {
  var t = this._id;
  return arguments.length ? this.each(ih(t, i)) : kt(this.node(), t).ease;
}
function rh(i, t) {
  return function() {
    var e = t.apply(this, arguments);
...
function sh(i) {
  ...
  return this.each(rh(this._id, i));
}
function oh(i) {
  typeof i != "function" && (i = rs(i));
  for (var t = this._groups, e = t.length, n = new Array(e), r = 0; r < e; ++r)
...
function hh(i, t) {
  var e = this._id;
  return arguments.length < 2 ? kt(this.node(), e).on.on(i) : this.each(ch(e, i, t));
}
function dh(i) {
  return function() {
...
function fh(i) {
  ...
  for (var n = this._groups, r = n.length, s = [], o = [], a = 0; a < r; ++a)
    for (var c = n[a], l = c.length, h, d = 0; d < l; ++d)
      if (h = c[d]) {
        for (var u = i.call(h, h.__data__, d, c), p, f = kt(h, e), v = 0, y = u.length; v < y; ++v)
          (p = u[v]) && bi(p, t, e, v, u, f);
        s.push(u), o.push(h);
      }
  return new Ft(s, o, t, e);
}
var gh = ce.prototype.constructor;
function mh() {
...
function xh(i, t, e) {
  var n = (i += "") == "transform" ? Ac : Ms;
  return t == null ? this.styleTween(i, vh(i, n)).on("end.style." + i, Es(i)) : typeof t == "function" ? this.styleTween(i, bh(i, n, An(this, "style." + i, t))).each(wh(this._id, i)) : this.styleTween(i, yh(i, n, t), e).on("end.style." + i, null);
}
function Ch(i, t, e) {
  return function(n) {
...
function kh(i) {
  return this.tween("text", typeof i == "function" ? _h(An(this, "text", i)) : Sh(i == null ? "" : i + ""));
}
function Nh(i) {
  return function(t) {
...
function zh(i) {
  var t, e;
  i instanceof Ft ? (t = i._id, i = i._name) : (t = Ss(), (e = Dh).time = Sn(), i = i == null ? null : i + "");
  for (var n = this._groups, r = n.length, s = 0; s < r; ++s)
    for (var o = n[s], a = o.length, c, l = 0; l < a; ++l)
      (c = o[l]) && bi(c, i, t, l, o, e || Fh(c, t));
  return new Ft(n, this._parents, i, t);
}
ce.prototype.interrupt = lc;
ce.prototype.transition = zh;
const Bh = { passive: !1 }, Se = { capture: !0, passive: !1 };
function Bi(i) {
...
function qh() {
  var i = Rh, t = Hh, e = $h, n = Gh, r = {}, s = Ne("start", "drag", "end"), o = 0, a, c, l, h, d = 0;
  function u(C) {
    C.on("mousedown.drag", p).filter(n).on("touchstart.drag", y).on("touchmove.drag", b, Bh).on("touchend.drag touchcancel.drag", x).style("touch-action", "none").style("-webkit-tap-highlight-color", "rgba(0,0,0,0)");
  }
  function p(C, N) {
    if (!(h || !i.call(this, C, N))) {
      var P = S(this, t.call(this, C, N), C, N, "mouse");
      P && (tt(C.view).on("mousemove.drag", f, Se).on("mouseup.drag", v, Se), _s(C.view), Bi(C), l = !1, a = C.clientX, c = C.clientY, P("start", C));
    }
  }
  function f(C) {
    if (ne(C), !l) {
...
function Kh() {
  var i = Uh, t = jh, e = Wh, n = Yh, r = Xh, s = [0, 1 / 0], o = [[-1 / 0, -1 / 0], [1 / 0, 1 / 0]], a = 250, c = Pc, l = Ne("start", "zoom", "end"), h, d, u, p = 500, f = 150, v = 0, y = 10;
  function b(E) {
  ...
  function A(E, ...L) {
    ...
    fe(E), _.wheel = setTimeout(H, f), _.zoom("mouse", e(S(x(O, B), _.mouse[0], _.mouse[1]), _.extent, o));
    function H() {
      _.wheel = null, _.end();
    }
  }
...
function Ns(i, t, e, n) {
  ...
  var r, s = i._root, o = { data: n }, a = i._x0, c = i._y0, l = i._x1, h = i._y1, d, u, p, f, v, y, b, x;
  if (!s) return i._root = o, i;
  for (; s.length; )
    if ((v = t >= (d = (a + l) / 2)) ? a = d : l = d, (y = e >= (u = (c + h) / 2)) ? c = u : h = u, r = s, !(s = s[b = y << 1 | v])) return r[b] = o, i;
  if (p = +i._x.call(null, s.data), f = +i._y.call(null, s.data), t === p && e === f) return o.next = s, r ? r[b] = o : i._root = o, i;
  do
    r = r ? r[b] = new Array(4) : i._root = new Array(4), (v = t >= (d = (a + l) / 2)) ? a = d : l = d, (y = e >= (u = (c + h) / 2)) ? c = u : h = u;
  while ((b = y << 1 | v) === (x = (f >= u) << 1 | p >= d));
...
function nd(i, t, e) {
  var n, r = this._x0, s = this._y0, o, a, c, l, h = this._x1, d = this._y1, u = [], p = this._root, f, v;
  for (p && u.push(new dt(p, r, s, h, d)), e == null ? e = 1 / 0 : (r = i - e, s = t - e, h = i + e, d = t + e, e *= e); f = u.pop(); )
    if (!(!(p = f.node) || (o = f.x0) > h || (a = f.y0) > d || (c = f.x1) < r || (l = f.y1) < s))
      if (p.length) {
        var y = (o + c) / 2, b = (a + l) / 2;
        u.push(
          new dt(p[3], y, b, c, l),
          ...
          new dt(p[1], y, a, c, b),
          new dt(p[0], o, a, y, b)
        ), (v = (t >= b) << 1 | i >= y) && (f = u[u.length - 1], u[u.length - 1] = u[u.length - 1 - v], u[u.length - 1 - v] = f);
      } else {
...
function rd(i) {
  ...
  var t, e = this._root, n, r, s, o = this._x0, a = this._y0, c = this._x1, l = this._y1, h, d, u, p, f, v, y, b;
  if (!e) return this;
  if (e.length) for (; ; ) {
    if ((f = h >= (u = (o + c) / 2)) ? o = u : c = u, (v = d >= (p = (a + l) / 2)) ? a = p : l = p, t = e, !(e = e[y = v << 1 | f])) return this;
    if (!e.length) break;
...
function Ln(i, t, e) {
  var n = new On(t ?? hd, e ?? ud, NaN, NaN, NaN, NaN);
...
function md(i) {
  ...
  function o() {
    for (var l, h = t.length, d, u, p, f, v, y, b = 0; b < s; ++b)
      for (d = Ln(t, fd, gd).visitAfter(a), l = 0; l < h; ++l)
        u = t[l], v = e[u.index], y = v * v, p = u.x + u.vx, f = u.y + u.vy, d.visit(x);
    function x(S, C, N, P, k) {
      var A = S.data, I = S.r, z = v + I;
      if (A) {
        if (A.index > u.index) {
          var F = p - A.x - A.vx, Z = f - A.y - A.vy, Q = F * F + Z * Z;
          Q < z * z && (F === 0 && (F = Ht(n), Q += F * F), Z === 0 && (Z = Ht(n), Q += Z * Z), Q = (z - (Q = Math.sqrt(Q))) / Q * r, u.vx += (F *= Q) * (z = (I *= I) / (y + I)), u.vy += (Z *= Q) * z, A.vx -= F * (z = 1 - z), A.vy -= Z * z);
        }
        return;
      }
      return C > p + z || P < p - z || N > f + z || k < f - z;
    }
  }
  function a(l) {
...
function yd(i) {
  var t = vd, e = d, n, r = nt(30), s, o, a, c, l, h = 1;
  i == null && (i = []);
  function d(y) {
  ...
  function p() {
    if (o) {
      ...
      n = new Array(x), f(), s = new Array(x), v();
    }
  }
  function f() {
    if (o)
  ...
  return u.initialize = function(y, b) {
    ...
    return arguments.length ? (e = typeof y == "function" ? y : nt(+y), f(), u) : e;
  }, u.distance = function(y) {
    return arguments.length ? (r = typeof y == "function" ? y : nt(+y), v(), u) : r;
  }, u;
}
const bd = 1664525, wd = 1013904223, Cr = 4294967296;
function xd() {
  let i = 1;
  return () => (i = (bd * i + wd) % Cr) / Cr;
}
function Cd(i) {
  return i.x;
}
...
var Ed = 10, Sd = Math.PI * (3 - Math.sqrt(5));
function _d(i) {
  var t, e = 1, n = 1e-3, r = 1 - Math.pow(n, 1 / 300), s = 0, o = 0.6, a = /* @__PURE__ */ new Map(), c = _n(d), l = Ne("tick", "end"), h = xd();
  i == null && (i = []);
  function d() {
  ...
  function p() {
    for (var v = 0, y = i.length, b; v < y; ++v) {
      if (b = i[v], b.index = v, b.fx != null && (b.x = b.fx), b.fy != null && (b.y = b.fy), isNaN(b.x) || isNaN(b.y)) {
        var x = Ed * Math.sqrt(0.5 + v), S = v * Sd;
  ...
  return p(), t = {
    ...
    nodes: function(v) {
      return arguments.length ? (i = v, p(), a.forEach(f), t) : i;
    },
    alpha: function(v) {
    ...
    randomSource: function(v) {
      return arguments.length ? (h = v, a.forEach(f), t) : h;
    },
    force: function(v, y) {
      return arguments.length > 1 ? (y == null ? a.delete(v) : a.set(v, f(y)), t) : a.get(v);
    },
    find: function(v, y, b) {
...
function kd() {
  ...
  function l(p) {
    var f, v = i.length, y = Ln(i, Cd, Md).visitAfter(d);
    for (n = p, f = 0; f < v; ++f) t = i[f], y.visit(u);
  }
  function h() {
    if (i) {
      var p, f = i.length, v;
      for (s = new Array(f), p = 0; p < f; ++p) v = i[p], s[v.index] = +r(v, p, i);
    }
  }
  function d(p) {
    var f = 0, v, y, b = 0, x, S, C;
    if (p.length) {
      for (x = S = C = 0; C < 4; ++C)
        (v = p[C]) && (y = Math.abs(v.value)) && (f += v.value, b += y, x += y * v.x, S += y * v.y);
      p.x = x / b, p.y = S / b;
    } else {
  ...
  function u(p, f, v, y) {
    if (!p.value) return !0;
    var b = p.x - t.x, x = p.y - t.y, S = y - f, C = b * b + x * x;
    if (S * S / c < C)
  ...
  return l.initialize = function(p, f) {
    i = p, e = f, h();
...
function Mr(i, t, e) {
  ...
  function a(l) {
    for (var h = 0, d = n.length; h < d; ++h) {
      var u = n[h], p = u.x - t || 1e-6, f = u.y - e || 1e-6, v = Math.sqrt(p * p + f * f), y = (o[h] - v) * s[h] * l / v;
      u.vx += p * y, u.vy += f * y;
    }
  }
  function c() {
...
class it {
  ...
  createSubgraph(t, e, n, r, s) {
    const o = (u) => {
      u.getMutableNodes().forEach((p) => {
        let f = s.getMutableNode(p.id);
        f = f.getOriginalObject() ?? f, p.setOriginalObject(f), f.setDeepestNodeClone(p), p.isChild = !0;
      }), u.getMutableEdges().forEach((p) => {
        let f = s.getMutableEdge(p.id);
        f && (f = f.getOriginalObject() ?? f, p.setOriginalObject(f));
      }), t.forEach((p) => {
        var f;
        if (((f = p.parentNode) == null ? void 0 : f.id) === r.id) {
          const v = u.getMutableNode(p.id);
          v && (v.parentNode = r);
        }
      }), s.getMutableEdges().forEach((p) => {
        const f = p.getOriginalObject() ?? p, v = u.getMutableNode(p.from.id), y = u.getMutableNode(p.to.id);
      ...
      callbacks: {
        ...
        onNodesSelect: (u) => {
          ...
          s.renderer.getGraphInteraction().addNodesToSelection(f);
        },
        onEdgeSelect: (u) => {
        ...
        onNodeHoverIn: (u, p) => {
          var f;
          (f = s.UIManager.tooltip) == null || f.openForNodeOnElement(u, p);
        }
      },
    ...
    return n.appendChild(d), h.getMutableNodes().forEach((u) => {
      ...
      h.simulation.getSimulation().force("center", Zh(0, 0)).force("constrainParent", fn(r.getCircleRadius(), 10)), h.simulation.restart();
      ...
      h.getMutableNodes().filter((p) => p.visible).forEach((p) => {
        const f = p.x ?? 0, v = p.y ?? 0;
        this.updatePositionOnRealChild(f, v, p.id);
      });
  ...
  updatePositionOnRealChild(t, e, n) {
    ...
    if (r && s) {
      const o = Nd.localToGlobal(t, e, s);
...
class wi {
  constructor(t, e, n) {
    g(this, "graph");
    g(this, "rendererOptions");
    g(this, "graphSvgRenderer");
    g(this, "clusterDrawer");
    g(this, "renderCB");
    var r;
  ...
  genericNodeRender(t, e, n) {
    ...
    switch (e.shape) {
      ...
      case "hexagon": {
        const l = Math.PI / 3, h = Array.from({ length: 6 }, (d, u) => {
          const p = l * u;
          return [Math.cos(p) * e.size, Math.sin(p) * e.size];
        }).map((d) => d.join(",")).join(" ");
        s.attr("d", `M${h}Z`), n.setCircleRadius(e.size);
        break;
      }
      default:
    ...
    if (e.iconUnicode || e.iconClass)
      ...
      l.innerHTML = e.svgIcon, ((o = l.children[0]) == null ? void 0 : o.nodeName) === "svg" && (l.children[0].removeAttribute("width"), l.children[0].removeAttribute("height")), t.append(() => l).attr("class", "node-content").attr("x", -e.size * 0.7).attr("y", -e.size * 0.7).attr("width", e.size * 1.4).attr("height", e.size * 1.4).attr("color", e.strokeColor);
    } else if (e.imagePath)
      ...
      const l = t.append("foreignObject"), h = e.html(n);
      l.attr("width", e.size * 2).attr("height", e.size * 2).attr("x", -e.size).attr("y", -e.size), typeof h == "string" ? l.text(h) : h instanceof HTMLElement && ((a = l.node()) == null || a.append(h));
    }
    if (e.text) {
      const [l, h] = this.computeTextLayout(e.text, e.size, e.textVerticalShift), u = (c = t.append("text").attr("text-anchor", "middle").attr("y", -e.textVerticalShift * (e.size + l / 2 * 1.2)).attr("dominant-baseline", "central").attr("font-size", l).attr("font-family", e.fontFamily).attr("fill", e.textColor).text(h).node()) == null ? void 0 : c.getBBox();
      Math.abs(e.textVerticalShift) >= 1 && u && t.insert("rect", "text").attr("x", u.x - 4).attr("y", u.y - 2).attr("width", u.width + 8).attr("height", u.height + 4).attr("fill", Os.backgroundColor).attr("rx", 2).attr("ry", 2);
    }
  }
  ...
  computeTextLayout(t, e, n = 0) {
    const r = e * 0.9, s = Math.abs(n) >= 1 ? r * 5 : r * 2, o = Math.max(12, r * 0.5), a = o * 0.55, c = Math.floor(s / a) - 1;
    if (t.length > c && t.length > 7) {
      const l = Math.max(6, s / a) - 1, h = 3, d = l - h;
...
function Id(i) {
  let { rx: t, ry: e } = i;
  const { xAxisRotation: n, from: r, to: s } = i, o = Ad(n), a = Math.cos(o), c = Math.sin(o), l = (r.x - s.x) / 2, h = (r.y - s.y) / 2, d = a * l + c * h, u = -c * l + a * h;
  let p = t * t, f = e * e;
  const v = d * d, y = u * u, b = v / p + y / f;
  if (b > 1) {
    const O = Math.sqrt(b);
    t *= O, e *= O, p = t * t, f = e * e;
  }
  const x = 1, S = p * f - p * y - f * v, C = p * y + f * v, N = x * Math.sqrt(Math.max(0, S / C)), P = N * (t * u / e), k = N * (-(e * d) / t), A = a * P - c * k + (r.x + s.x) / 2, I = c * P + a * k + (r.y + s.y) / 2;
  function z(O, B, R, H) {
...
function Ld(i, t, e, n, r, s) {
  const o = n - i, a = r - t, c = Math.sqrt(o * o + a * a);
  if (c > e + s) return [];
  if (c < Math.abs(e - s)) return [];
  if (c === 0 && e === s) return [];
  const l = (e * e - s * s + c * c) / (2 * c), h = Math.sqrt(e * e - l * l), d = i + l * o / c, u = t + l * a / c, p = d + h * a / c, f = u - h * o / c, v = d - h * a / c, y = u + h * o / c;
  return h === 0 ? [{ x: p, y: f }] : [
    { x: p, y: f },
    { x: v, y }
  ];
...
function Dd(i) {
  ...
  const e = zd(t);
  if (!e) return null;
  const n = e.to.x - e.from.x, r = e.to.y - e.from.y, s = Math.hypot(n, r), o = e.rx, a = 2 * Math.asin(Math.min(s / (2 * o), 1)), c = o * a, l = (e.from.x + e.to.x) / 2, h = (e.from.y + e.to.y) / 2, d = Math.sqrt(Math.max(0, o * o - (s / 2) ** 2)), u = -r / s, p = n / s, f = e.sweepFlag !== e.largeArcFlag ? 1 : -1, v = l + f * d * u, y = h + f * d * p, b = Math.atan2(e.from.y - y, e.from.x - v);
...
class Hd {
  ...
  updatePositions(t) {
    ...
    e.attr("d", (r) => this.linkPathRouter(r)), n.attr("transform", (r, s, o) => {
      ...
      let u, p, f = { x: 0, y: 0 }, v = 0;
      if (a === c) {
        const y = d ? Fd(d) : void 0, { length: b = 0, midpoint: x = { x: 0, y: 0 } } = y ?? {};
        v = b, f = x;
  ...
  linkStraight(t) {
    ...
    const p = e.getCircleRadius() ? e.getCircleRadius() : this.graphSvgRenderer.nodeDrawer.getNodeStyle(e).size, f = t.getSubgraphToNode() ?? t.to, v = f.getCircleRadius() ? f.getCircleRadius() : this.graphSvgRenderer.nodeDrawer.getNodeStyle(f).size;
  ...
  linkArc(t) {
    ...
    return f && v ? `M${f.x},${f.y} A${s},${s} 0 0,1 ${v.x},${v.y}` : "";
  }
...
function qd() {
  return kr || (kr = 1, (function(i, t) {
    ...
    var no = Array.prototype, ro = Function.prototype, Ie = Object.prototype, Si = lt["__core-js_shared__"], Le = ro.toString, zt = Ie.hasOwnProperty, Bn = (function() {
      var m = /[^.]+$/.exec(Si && Si.keys && Si.keys.IE_PROTO || "");
      return m ? "Symbol(src)_1." + m : "";
    })(), Rn = Ie.toString, so = Le.call(Object), oo = RegExp(
      "^" + Le.call(zt).replace(H, "\\$&").replace(/hasOwnProperty|(function).*?(?=\\\()| for .+?(?=\\\])/g, "$1.*?") + "$"
    ), Oe = Zt ? lt.Buffer : void 0, Hn = lt.Symbol, $n = lt.Uint8Array;
    Oe && Oe.allocUnsafe;
    var Gn = io(Object.getPrototypeOf, Object), qn = Object.create, ao = Ie.propertyIsEnumerable, lo = no.splice, $t = Hn ? Hn.toStringTag : void 0, Te = (function() {
      try {
        var m = Ni(Object, "defineProperty");
        return m({}, "", {}), m;
      } catch {
      }
    })(), co = Oe ? Oe.isBuffer : void 0, Vn = Math.max, ho = Date.now, Un = Ni(lt, "Map"), he = Ni(Object, "create"), uo = /* @__PURE__ */ (function() {
      function m() {
      }
      return function(w) {
        if (!qt(w))
    ...
    Gt.prototype.clear = po, Gt.prototype.delete = fo, Gt.prototype.get = go, Gt.prototype.has = mo, Gt.prototype.set = vo;
    function Ot(m) {
      var w = -1, M = m == null ? 0 : m.length;
      for (this.clear(); ++w < M; ) {
        var D = m[w];
    ...
    function bo(m) {
      ...
      if (M < 0)
        return !1;
      var D = w.length - 1;
      return M == D ? w.pop() : lo.call(w, M, 1), --this.size, !0;
    }
    function wo(m) {
      var w = this.__data__, M = Pe(w, m);
    ...
    Ot.prototype.clear = yo, Ot.prototype.delete = bo, Ot.prototype.get = wo, Ot.prototype.has = xo, Ot.prototype.set = Co;
    function Qt(m) {
      var w = -1, M = m == null ? 0 : m.length;
      for (this.clear(); ++w < M; ) {
        var D = m[w];
    ...
    Qt.prototype.clear = Mo, Qt.prototype.delete = Eo, Qt.prototype.get = So, Qt.prototype.has = _o, Qt.prototype.set = ko;
    function Jt(m) {
    ...
    Jt.prototype.clear = No, Jt.prototype.delete = Ao, Jt.prototype.get = Io, Jt.prototype.has = Lo, Jt.prototype.set = Oo;
    function To(m, w) {
      var M = Li(m), D = !M && Ii(m), G = !M && !D && Kn(m), U = !M && !D && !G && Qn(m), X = M || D || G || U, q = X ? Js(m.length, String) : [], W = q.length;
      for (var xt in m)
    ...
    var Do = Xo();
    function De(m) {
      return m == null ? m === void 0 ? k : b : $t && $t in Object(m) ? Wo(m) : ea(m);
    }
    function jn(m) {
      return de(m) && De(m) == a;
    }
    ...
    function Ro(m, w, M, D, G, U, X) {
      ...
      if (ue) {
        ...
        vt = W, Pi || Di || er ? Li(q) ? vt = q : oa(q) ? vt = Uo(q) : Di ? (ue = !1, vt = Go(W)) : er ? (ue = !1, vt = Vo(W)) : vt = [] : aa(W) || Ii(W) ? (vt = q, Ii(q) ? vt = la(q) : (!qt(q) || Ti(q)) && (vt = Ko(W))) : ue = !1;
      }
      ue && (X.set(W, vt), G(vt, W, D, U, X), X.delete(W)), _i(m, M, vt);
    }
    function Ho(m, w) {
      return na(ia(m, w, tr), m + "");
    }
    var $o = Te ? function(m, w) {
    ...
    function jo(m, w, M, D) {
      ...
      for (var U = -1, X = w.length; ++U < X; ) {
        var q = w[U], W = void 0;
        W === void 0 && (W = m[q]), G ? ki(M, q, W) : Po(M, q, W);
      }
      return M;
    }
    function Yo(m) {
      return Ho(function(w, M) {
        var D = -1, G = M.length, U = G > 1 ? M[G - 1] : void 0, X = G > 2 ? M[2] : void 0;
        for (U = m.length > 3 && typeof U == "function" ? (G--, U) : void 0, X && Zo(M[0], M[1], X) && (U = G < 3 ? void 0 : U, G = 1), w = Object(w); ++D < G; ) {
          var q = M[D];
          q && m(w, q, D, U);
        }
        return w;
    ...
    function Fe(m, w) {
      var M = m.__data__;
      return Qo(w) ? M[typeof w == "string" ? "string" : "hash"] : M.map;
    }
    function Ni(m, w) {
      var M = eo(m, w);
    ...
    function Ko(m) {
      return typeof m.constructor == "function" && !Wn(m) ? uo(Gn(m)) : {};
    }
    function Xn(m, w) {
      var M = typeof m;
    ...
    var Ii = jn(/* @__PURE__ */ (function() {
      ...
      return de(m) && zt.call(m, "callee") && !ao.call(m, "callee");
    }, Li = Array.isArray;
    function Oi(m) {
    ...
    function aa(m) {
      ...
      return typeof M == "function" && M instanceof M && Le.call(M) == so;
    }
    var Qn = zn ? to(zn) : zo;
    function la(m) {
      return jo(m, Jn(m));
    ...
    function Jn(m) {
      return Oi(m) ? To(m) : Bo(m);
    }
    var ca = Yo(function(m, w, M) {
      Yn(m, w, M);
    });
    function ha(m) {
      return function() {
...
var Vd = qd();
const re = /* @__PURE__ */ Gd(Vd);
class Ud {
  constructor(t) {
    g(this, "graph");
    g(this, "callbacks");
    g(this, "listeners");
    g(this, "selectedNode", null);
    g(this, "selectedEdge", null);
    g(this, "selectedNodes", []);
    g(this, "selectedEdges", []);
    g(this, "nodeHoverIn", (t, e, n) => {
...
class jd {
  constructor(t, e, n) {
    ...
    g(this, "container");
    g(this, "options");
    g(this, "layoutProgress", 0);
    g(this, "layoutProgressType", "done");
    g(this, "progressBar", null);
    g(this, "timerLabel", null);
    g(this, "textLabel", null);
    g(this, "loadingPb", null);
...
class Xd extends Yd {
  constructor(e, n, r) {
    ...
    g(this, "renderer");
    g(this, "svg");
    g(this, "selectionBoxGroup");
    g(this, "rect", null);
    g(this, "startX", 0);
    g(this, "startY", 0);
    g(this, "isSelecting", !1);
    g(this, "selectionMode", "start");
    g(this, "onSvgMouseLeave", () => {
...
class Jd extends jd {
  constructor(e, n, r, s) {
    ...
    g(this, "selectionBoxGroup");
    g(this, "defs");
    g(this, "nodeGroupSelection");
    g(this, "edgeGroupSelection");
    g(this, "nodeSelection");
    g(this, "edgeSelection");
    this.options = re({}, Qd, s), this.graphInteraction = r, this.eventHandler = new $d(this.graph), this.nodeDrawer = new wi(this.options, this.graph, this), this.edgeDrawer = new Hd(this.options, this.graph, this), this.svgCanvas = document.createElementNS("http://www.w3.org/2000/svg", "svg"), this.svgCanvas.setAttribute("width", "100%"), this.svgCanvas.setAttribute("height", "100%"), this.svgCanvas.setAttribute("fill", "none"), this.svgCanvas.setAttribute("class", "pvt-canvas-element"), this.svgCanvas.setAttribute("data-renderer-drag-enabled", this.options.dragEnabled ? "1" : "0"), this.getCanvas().appendChild(this.svgCanvas), this.svg = tt(this.svgCanvas), this.zoomGroup = this.svg.append("g").attr("class", "zoom-layer hidden"), this.edgeGroup = this.zoomGroup.append("g").attr("class", "edges"), this.selectionBoxGroup = this.svg.append("g").attr("class", "selection-box"), this.nodeGroup = this.zoomGroup.append("g").attr("class", "nodes"), this.defs = this.svg.append("defs"), this.edgeDrawer.renderDefinitions(), this.zoom = Kh(), this.zoom = this.zoom.filter((a) => {
    ...
    }), this.svg.call(this.zoom), this.svg.on("dblclick.zoom", null), this.options.selectionBox.enabled && (this.selectionBox = new Xd(this, this.svgCanvas, this.selectionBoxGroup.node())), new IntersectionObserver((a) => {
      a.forEach((c) => {
  ...
  fitAndCenter(e) {
    ...
    const v = c / 2 - f * u, y = l / 2 - f * p, b = ui.translate(v, y).scale(f);
  ...
  focusElement(e) {
    ...
    if (p.numberOfItems > 0) {
      const C = p.getItem(0);
      f = C.matrix.e, v = C.matrix.f;
    }
    const y = Math.min(
      l / d,
      h / u
    ) * 1.5, b = l / 2 - y * f, x = h / 2 - y * v, S = ui.translate(b, x).scale(y);
...
const iu = (i, t, e, n, r) => new Promise((s, o) => {
  const a = new Worker(new URL(
    /* @vite-ignore */
    "/static/pivotick/assets/SimulationWorker-kgekWV9K.js",
    import.meta.url
  ), {
    type: "module"
  });
...
function Ts() {
  ...
  function r(l) {
    ...
    if (h.eachAfter(s), h.parent.m = -h.z, h.eachBefore(o), n) l.eachBefore(c);
      ...
      var f = d === u ? 1 : i(d, u) / 2, v = f - d.x, y = t / (u.x + f + v), b = e / (p.depth || 1);
      l.eachBefore(function(x) {
  ...
  function a(l, h, d) {
    if (h) {
      for (var u = l, p = l, f = h, v = u.parent.children[0], y = u.m, b = p.m, x = f.m, S = v.m, C; f = $i(f), u = Hi(u), f && u; )
        v = Hi(v), p = $i(p), p.a = l, C = f.z + x - u.z - y + i(f._, u._), C > 0 && (Eu(_u(f, l, d), l, C), y += C, b += C), x += f.m, y += u.m, S += v.m, b += p.m;
      f && !$i(p) && (p.t = f, p.m += x - b), u && !Hi(v) && (v.t = u, v.m += y - S, d = l);
    }
    return d;
  }
  function c(l) {
...
class At {
  constructor(t, e, n, r = {}) {
    g(this, "graph");
    g(this, "simulation");
    g(this, "simulationForces");
    g(this, "options");
    g(this, "originalForceStrength");
    g(this, "canvasBCR");
    g(this, "levels");
    g(this, "positionedNodesByID");
  ...
  static registerForcesOnSimulation(t, e, n, r, s, o, a = this) {
    ...
    if (we(t, e))
      return;
    const { levels: p } = a.buildLevels(t, e, void 0, c.rootIdAlgorithmFinder), { nodeById: f } = a.buildTree(t, e, c, o);
    if (c.radial) {
      const v = Mr(
        (y) => (p[y.id] ?? 1) * 100,
        u[0],
      ...
      n.force("tree-y", Sr((v) => {
        var y, b;
        return c.horizontal ? ((y = f.get(v.id)) == null ? void 0 : y.x) ?? 0 : ((b = f.get(v.id)) == null ? void 0 : b.y) ?? 0;
      }).strength(l)), n.force("tree-x", Er((v) => {
        var y, b;
        return c.horizontal ? ((y = f.get(v.id)) == null ? void 0 : y.y) ?? 0 : ((b = f.get(v.id)) == null ? void 0 : b.x) ?? 0;
      }).strength(l));
  ...
  static buildTree(t, e, n, r) {
    ...
    const c = n.radialGap, l = n.radial ? 2 * Math.PI : r.width, h = n.radial ? c : r.height, d = Ts();
    ...
    const u = xi(a), p = d(u), f = /* @__PURE__ */ new Map();
...
class ee {
  constructor(t, e = {}) {
    ...
    g(this, "startSimulationTime", 0);
    g(this, "engineRunning", !1);
    g(this, "slowTickThresholdReached", !1);
    g(this, "lastTickTime", 0);
    g(this, "avgTickDuration", 0);
    g(this, "SLOW_TICK_THRESHOLD", 50);
    // ms (20fps budget)
    g(this, "dragInProgress", !1);
    g(this, "dragSelection", []);
    g(this, "totalTickCount", 0);
    g(this, "options");
    g(this, "callbacks");
    g(this, "simulationForces");
    g(this, "scaledForces", {
  ...
  static initSimulationForces(t, e) {
    ...
    }, r = _d().force("link", n.link).force("charge", n.charge).force("center", n.center).force("collide", n.collide).force("gravity", n.gravity);
  ...
  async computeGraph(t = {}) {
    var h;
    const { runSimulation: e } = await import("./SimulationWorker-CMCzaGDQ.js"), n = (h = this.canvas) == null ? void 0 : h.getBoundingClientRect();
    if (!n) return;
   ...
   */
  createDragBehavior() {
    return qh().on("start.draggedelement", (t, e) => {
...
</svg>`, Fs = (i) => `<svg xmlns="http://www.w3.org/2000/svg" width="${i}" height="${i}" viewBox="0 0 256 256" ><g fill="currentColor"><path d="M216 40v176H40V40Z" opacity="0.2"/><path d="M152 40a8 8 0 0 1-8 8h-32a8 8 0 0 1 0-16h32a8 8 0 0 1 8 8m-8 168h-32a8 8 0 0 0 0 16h32a8 8 0 0 0 0-16m64-176h-24a8 8 0 0 0 0 16h24v24a8 8 0 0 0 16 0V48a16 16 0 0 0-16-16m8 72a8 8 0 0 0-8 8v32a8 8 0 0 0 16 0v-32a8 8 0 0 0-8-8m0 72a8 8 0 0 0-8 8v24h-24a8 8 0 0 0 0 16h24a16 16 0 0 0 16-16v-24a8 8 0 0 0-8-8M40 152a8 8 0 0 0 8-8v-32a8 8 0 0 0-16 0v32a8 8 0 0 0 8 8m32 56H48v-24a8 8 0 0 0-16 0v24a16 16 0 0 0 16 16h24a8 8 0 0 0 0-16m0-176H48a16 16 0 0 0-16 16v24a8 8 0 0 0 16 0V48h24a8 8 0 0 0 0-16"/></g></svg>`, Uu = '<svg width="16" height="16"viewBox="0 0 3.4393651 3.7032704" version="1.1" id="svg1" xmlns="http://www.w3.org/2000/svg" xmlns:svg="http://www.w3.org/2000/svg"> <defs id="defs1" /> <g id="layer1" transform="translate(-128.32315,-97.896729)" fill="currentColor"> <path id="path1" d="m 130.91707,97.898417 a 0.79375,0.79375 0 0 0 -0.71416,0.999939 l -0.51729,0.296106 a 0.79375,0.79375 0 1 0 0,1.107428 l 0.51729,0.29559 a 0.79454375,0.79454375 0 0 0 0.76584,1.00252 0.79375,0.79375 0 1 0 -0.56896,-1.3472 l -0.51728,-0.296111 a 0.79375,0.79375 0 0 0 0,-0.417545 l 0.51728,-0.296106 a 0.79375,0.79375 0 0 0 1.36271,-0.553455 0.79375,0.79375 0 0 0 -0.84543,-0.791166 z m 0.0517,0.394291 a 0.396875,0.396875 0 0 1 0,0.79375 0.396875,0.396875 0 1 1 0,-0.79375 z m 0,2.116662 a 0.396875,0.396875 0 0 1 0,0.79375 0.396875,0.396875 0 0 1 0,-0.79375 z" /> </g> </svg> ', zs = `<svg aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 20 20">
    <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m19 19-4-4m0-7A7 7 0 1 1 1 8a7 7 0 0 1 14 0Z"/>
</svg>`, Bs = `<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16">
...
class ap {
  constructor(t) {
    g(this, "uiManager");
    g(this, "navigation");
    g(this, "selectionMenu");
    g(this, "layoutMenu");
    g(this, "selectionMenuShown", !1);
    g(this, "menuNode");
    g(this, "layoutTypeOptions", [
      {
        root: {
...
class cp {
  constructor() {
    ...
    g(this, "modal");
    g(this, "slidePanel");
    g(this, "graphnavigation");
    g(this, "graphcontrols");
  }
  mount(t, e = "full") {
...
function fp(i, t) {
  if (wn(i)) {
    let e = "", n = "";
    return $s(i) ? (e = "- empty -", n = "The value is empty") : Gs(i) && (e = `- ${t} other unique values -`, n = "All other values are unique"), T("span", { class: "pvt-aggregated-property-value-dim", title: n }, [
      e
    ]);
  }
...
function qs(i) {
  ...
  for (const [p, f] of Object.entries(l))
    p === "class" ? Array.isArray(f) ? h.classList.add(...f) : h.classList.add(String(f)) : p in h ? h[p] = f : h.setAttribute(p, String(f));
  let d;
...
class bp {
  constructor(t) {
    ...
    g(this, "header");
    g(this, "body");
    g(this, "neighborCount");
    g(this, "egographContainer");
    g(this, "statContainer");
...
<div class="enter-ready">
    ...
    const a = {
      ...
      UI: {
        ...
        tooltip: {
          ...
          allowPinning: !1,
          setPosition: (l, h, d) => {
            l.style.left = `${d.x + d.width + 15}px`, l.style.top = `${d.y}px`;
          }
        },
        contextMenu: {
          enabled: !1
      ...
      callbacks: {
        onNodeClick: (l, h) => {
          ...
          d && ((u = this.uiManager.graph.renderer.getGraphInteraction().getSelectedNode()) == null ? void 0 : u.node) != d && (this.uiManager.graph.unHighlightElement(d), (p = this.egoGraph) == null || p.unHighlightElement(h), this.uiManager.graph.selectElement(d));
        },
        onNodeHoverIn: (l, h) => {
          var u, p, f;
          const d = this.uiManager.graph.getMutableNode(h.id);
          d && (this.uiManager.graph.highlightElement(d), (u = this.egoGraph) == null || u.highlightElement(h), (f = (p = this.egoGraph) == null ? void 0 : p.UIManager.tooltip) == null || f.nodeHovered(l, h));
        },
        onNodeHoverOut: (l, h) => {
          var u;
          const d = this.uiManager.graph.getMutableNode(h.id);
          d && (this.uiManager.graph.unHighlightElement(d), (u = this.egoGraph) == null || u.unHighlightElement(h));
        }
      }
    };
  ...
  buildList(t) {
    ...
    for (const s of n) {
      ...
      const u = d.content.firstElementChild, p = u.querySelector(".pvt-neighbors-list__nodepreview .pvt-mainheader-icon") ?? void 0, f = a.getGraphElement();
      if (p && f && f instanceof SVGGElement) {
        const x = f.cloneNode(!0), S = f.getBBox(), C = e / Math.max(S.width, S.height);
        x.setAttribute(
          "transform",
  ...
  mergeNodesIntoNode(t) {
    const e = {
      ...
      html: (l) => {
        const d = l.getData().aggregated_node_count, u = Y({ svgIcon: Fs(28) });
...
class wp {
  constructor(t) {
    g(this, "uiManager");
    g(this, "sidebar");
    g(this, "sidebarOpen", !0);
    g(this, "sidebarMainHeader");
    g(this, "sidebarProperties");
    g(this, "sidebarNeighbors");
    g(this, "extraPanelManager");
    g(this, "mainHeaderPanel");
    g(this, "mainBodyPanel");
    g(this, "neighborPanel");
...
class xp {
  constructor(t, e = {}) {
    ...
    g(this, "body");
    g(this, "isOpen", !1);
    g(this, "DEFAULT_HEADER", null);
    g(this, "DEFAULT_BODY", "- empty panel -");
...
class Cp {
  constructor(t) {
    ...
    g(this, "searchBox");
    g(this, "searchInput");
    g(this, "searchResultsContainer");
    g(this, "searchSummaryContainer");
    g(this, "results");
    g(this, "highlightedIndex", 0);
    g(this, "MAX_RESULT_COUNT", 12);
    this.uiManager = t;
  }
  mount(t) {
...
`;
    ...
    if (d && d instanceof SVGGElement) {
      const u = d.cloneNode(!0), p = d.getBBox(), f = 30 / Math.max(p.width, p.height);
      u.setAttribute(
        "transform",
        `translate(${(30 - p.width * f) / 2 - p.x * f}, ${(30 - p.height * f) / 2 - p.y * f}) scale(${f})`
      ), a.appendChild(u);
    }
...
const Ci = (i) => (i = i.filter(Boolean), i.length < 2 ? i[0] || "" : _p(i) == 1 ? "[" + i.join("") + "]" : "(?:" + i.join("|") + ")"), Vs = (i) => {
  if (!Sp(i))
    return i.join("");
  let t = "", e = 0;
  const n = () => {
  ...
  let t = Array.from(i);
  return Ci(t);
}, Sp = (i) => new Set(i).size !== i.length, ke = (i) => (i + "").replace(/([\$\(\)\*\+\.\?\[\]\^\{\|\}\\])/gu, "\\$1"), _p = (i) => i.reduce((t, e) => Math.max(t, kp(e)), 0), kp = (i) => Array.from(i).length, js = (i) => {
  if (i.length === 1)
    return [[i]];
  let t = [];
  const e = i.substring(1);
  return js(e).forEach(function(r) {
    let s = r.slice(0);
...
const Dp = (i) => {
  const t = {}, e = (n, r) => {
    const s = t[n] || /* @__PURE__ */ new Set(), o = new RegExp("^" + Us(s) + "$", "iu");
  ...
  for (let s in t) {
    let o = t[s];
    o && (e[s] = Us(o)), s.length > 1 && n.push(ke(s));
  }
  n.sort((s, o) => o.length - s.length);
  const r = Ci(n);
  return Ys = new RegExp("^" + r, "u"), e;
}, zp = (i, t = 1) => {
  let e = 0;
  return i = i.map((n) => (fi[n] && (e += n.length), fi[n] || n)), e >= t ? Vs(i) : "";
}, Bp = (i, t = 1) => (t = Math.max(t, i.length - 1), Ci(js(i).map((e) => zp(e, t)))), Pr = (i, t = !0) => {
...
}, Xs = (i) => typeof i == "string" && i.indexOf("<") > -1, Xp = (i) => i.replace(/['"\\]/g, "\\$&"), tn = (i, t) => {
...
}, Ks = (i) => (Array.isArray(i) || (i = [i]), i), en = (i, t, e) => {
  if (!(e && !e.contains(i)))
    for (; i && i.matches; ) {
      if (i.matches(t))
        return i;
...
function Gr(i, t) {
  ...
  return h === "select" ? p() : f(), Object.assign({}, $r, u, t);
}
var qr = 0;
class at extends Ep(Mp) {
  constructor(t, e) {
    ...
    var f;
    if (yt(c, o.wrapperClass, u, p), yt(l, o.controlClass), jt(c, l), yt(h, o.dropdownClass, p), o.copyClassesToDropdown && yt(h, u), yt(d, o.dropdownContentClass), jt(h, d), Nt(o.dropdownParent || c).appendChild(h), Xs(o.controlInput)) {
      f = Nt(o.controlInput);
      var v = ["autocorrect", "autocapitalize", "autocomplete", "spellcheck"];
      rt(v, (y) => {
        r.getAttribute(y) && K(f, { [y]: r.getAttribute(y) });
      }), f.tabIndex = -1, l.appendChild(f), this.focus_node = f;
    } else o.controlInput ? (f = Nt(o.controlInput), this.focus_node = f) : (f = Nt("<input/>"), this.focus_node = l);
    this.wrapper = c, this.dropdown = h, this.dropdown_content = d, this.control = l, this.control_input = f, this.setup();
  }
  /**
  ...
  setup() {
    ...
    const u = Ji(l, t.inputId + "-ts-control"), p = "label[for='" + Xp(t.inputId) + "']", f = document.querySelector(p), v = t.focus.bind(t);
    if (f) {
      ht(f, "click", v), K(f, { for: u });
      const x = Ji(f, t.inputId + "-ts-label");
    ...
    ht(document, "mousedown", y), ht(window, "scroll", b, h), ht(window, "resize", b, h), this._destroy = () => {
      document.removeEventListener("mousedown", y), window.removeEventListener("scroll", b), window.removeEventListener("resize", b), f && f.removeEventListener("click", v);
    }, this.revertSettings = {
  ...
  refreshOptions(t = !0) {
    ...
    const y = v === f.lastQuery || v == "" && f.lastQuery == null;
    var b = f.search(v), x = null, S = f.settings.shouldOpen || !1, C = f.dropdown_content;
    y && (x = f.activeOption, x && (h = x.closest("[data-group]"))), s = b.items.length, typeof f.settings.maxOptions == "number" && (s = Math.min(s, f.settings.maxOptions)), s > 0 && (S = !0);
    const N = (k, A) => {
      let I = u[k];
      if (I !== void 0) {
        let F = p[I];
    ...
    for (e = 0; e < s; e++) {
      ...
      if (!k)
        continue;
      let A = k.id, I = f.options[A];
      if (I === void 0)
        continue;
      let z = ii(A), F = f.getOption(z, !0);
      for (f.settings.hideSelected || F.classList.toggle("selected", f.items.includes(z)), o = I[f.settings.optgroupField] || "", a = Array.isArray(o) ? o : [o], n = 0, r = a && a.length; n < r; n++) {
        o = a[n];
        let Z = I.$order, Q = f.optgroups[o];
        Q === void 0 ? o = "" : Z = Q.$order;
        const [E, L] = N(o, Z);
        n > 0 && (F = F.cloneNode(!0), K(F, { id: I.$id + "-clone-" + n, "aria-selected": null }), F.classList.add("ts-cloned"), Bt(F, "active"), f.activeOption && f.activeOption.dataset.value == A && h && h.dataset.group === o.toString() && (x = F)), L.appendChild(F), o != "" && (u[o] = E);
      }
    }
    f.settings.lockOptgroupOrder && p.sort((k, A) => k.order - A.order), c = document.createDocumentFragment(), rt(p, (k) => {
      let A = k.fragment, I = k.optgroup;
      if (!A || !A.children.length)
        return;
      let z = f.optgroups[I];
      if (z !== void 0) {
        let F = document.createDocumentFragment(), Z = f.render("optgroup_header", z);
        jt(F, Z), jt(F, A);
        let Q = f.render("optgroup", { group: z, options: F });
        jt(c, Q);
      } else
        jt(c, A);
    }), C.innerHTML = "", jt(C, c), f.settings.highlight && (Zp(C), b.query.length && b.tokens.length && rt(b.tokens, (k) => {
      Kp(C, k.regex);
    }));
    var P = (k) => {
      let A = f.render(k, { input: v });
      return A && (S = !0, C.insertBefore(A, C.firstChild)), A;
    };
    if (f.loading ? P("loading") : f.settings.shouldLoad.call(f, v) ? b.items.length === 0 && P("no_results") : P("not_loading"), l = f.canCreate(v), l && (d = P("option_create")), f.hasOptions = b.items.length > 0 || l, S) {
      if (b.items.length > 0) {
        if (!x && f.settings.mode === "single" && f.items[0] != null && (x = f.getOption(f.items[0])), !C.contains(x)) {
          let k = 0;
          d && !f.settings.addPrecedence && (k = 1), x = f.selectable()[k];
        }
      } else d && (x = d);
      t && !f.isOpen && (f.open(), f.scrollToOption(x, "auto")), f.setActiveOption(x);
    } else
      f.clearActiveOption(), t && f.isOpen && f.close(!1);
  }
  /**
...
function _f() {
  ...
  i.hook("after", "setupTemplates", () => {
    ...
    i.settings.render.item = (o, a) => {
      ...
      return te(c, "mousedown", l), te(c, "dragstart", h), te(c, "dragenter", d), te(c, "dragover", d), te(c, "dragleave", u), te(c, "dragend", f), c;
    };
...
class hg {
  constructor(t) {
    ...
    g(this, "graphFilter");
    g(this, "formOptions");
    g(this, "manuallyFilteredContainer");
  ...
  rebuild() {
    ...
    this.formOptions = Object.entries(e).map(([c, l]) => {
      ...
      l.values ? l.values && l.values.every((f) => f.length < 64) ? l.values.length > 2 ? (h = "multiselect", d = "partial") : h = "select" : l.values.every((f) => typeof f == "boolean") && (h = "select", l.values = ["true", "false"], u = !0) : h = "numberRange";
      const p = {
        key: c,
        label: c,
        type: h,
      ...
      return (p.type == "select" || p.type == "multiselect") && l.values && (p.options = l.values.map((f) => ({
        label: f,
        value: f
      })), p.allowEmpty = !0), p;
    });
...
class dg {
  constructor(t) {
    g(this, "uiManager");
    g(this, "toolbar");
    g(this, "searchBoxButton");
    g(this, "filterButton");
    g(this, "undoButton");
    g(this, "redoButton");
    g(this, "filteringSlidepanel");
    g(this, "searchModal");
    this.uiManager = t;
  }
  mount(t) {
  ...
  <div id="pvt-filter-button" class="pvt-action-button">
    <div class="action-container">
        <span class="icon-container">${Bs}</span>
...
class fg {
  constructor(t) {
    ...
    g(this, "options");
    g(this, "tooltip");
    g(this, "parentContainer");
    g(this, "shadowLinkContainer");
    g(this, "mouseX", 0);
    g(this, "mouseY", 0);
    g(this, "x", 0);
    g(this, "y", 0);
    g(this, "triggerX", 0);
    g(this, "triggerY", 0);
    g(this, "hoveredElementID", null);
    g(this, "hoveredElement", null);
    g(this, "showDelay", 400);
    g(this, "hideDelay", 200);
    g(this, "tooltipTimeout", null);
    g(this, "hideTimeout", null);
    g(this, "tooltipDataMap", /* @__PURE__ */ new Map());
    g(this, "shadowlinkMap", /* @__PURE__ */ new WeakMap());
    g(this, "shadowlinkBoundingBoxesMap", /* @__PURE__ */ new WeakMap());
...
<div class="pvt-tooltip-container">
  ...
  setPosition() {
    ...
    const t = (p = (u = this.hoveredElement) == null ? void 0 : u.getGraphElement()) == null ? void 0 : p.getBoundingClientRect();
    if (!t) return;
    const e = (v = (f = this.uiManager.layout) == null ? void 0 : f.canvas) == null ? void 0 : v.getBoundingClientRect();
    if (!e) return;
    ...
    const r = 20, s = 15, o = e.left + window.scrollX, a = e.top + window.scrollY, c = e.width, l = e.height, h = this.tooltip.offsetWidth, d = this.tooltip.offsetHeight;
    this.x = t.x + t.width + s, this.y = t.y, this.x + h + r > o + c && (this.x = t.x - h - s), this.x < o + s && (this.x = o + s), this.y + d + r > a + l && (this.y -= d), this.y < a + r && (this.y = a + r), this.tooltip.style.left = `${this.x}px`, this.tooltip.style.top = `${this.y}px`;
  }
  delayedHide(t, e) {
...
class bg {
  constructor() {
    g(this, "bindings", /* @__PURE__ */ new Map());
  }
  register(t) {
...
}, wg = (i) => Mi(i, "label", "Could not resolve title"), xg = (i) => Mi(i, "description"), Cg = (i) => Mi(i, "label", ""), Mg = (i) => Mi(i, "description"), Kr = (i) => Zs(i), Zr = (i) => Zs(i), Qr = {
  nodeHeaderMap: {
    title: wg,
    subtitle: xg
  },
...
class kg {
  constructor(t) {
    ...
    g(this, "listeners");
    g(this, "filters", {});
    g(this, "excludedNodeIds", /* @__PURE__ */ new Set());
    g(this, "hiddenNodeCount", 0);
...
class Ng {
  constructor(t) {
    g(this, "palette");
    g(this, "valueToColor", /* @__PURE__ */ new Map());
    g(this, "nextIndex", 0);
